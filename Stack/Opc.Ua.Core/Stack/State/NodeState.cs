...
namespace Opc.Ua
{
    ...
    public abstract class NodeState : IDisposable, IFormattable
    {
        ...
        public virtual void Save(ISystemContext context, XmlEncoder encoder)
        {
            ...
            if (!LocalizedText.IsNullOrEmpty(displayName))
            {
                if (m_browseName == null || !String.IsNullOrEmpty(displayName.Locale) || m_browseName.Name != displayName.Text)
                {
            ...
            ref object value)
        {
            ...
            switch (attributeId)
            {
                ...
                case Attributes.UserWriteMask:
                {
                    ...
                    NodeAttributeEventHandler<AttributeWriteMask> readUserWriteMask = OnReadUserWriteMask;
        ...
        public void AddReferences(IList<IReference> references)
        {
            ...
            foreach (var addedRef in addedReferences)
            {
                OnReferenceAdded?.Invoke(this, addedRef.ReferenceTypeId, addedRef.IsInverse, addedRef.TargetId);
            }
        }
        ...
        protected readonly object m_childrenLock = new object();
